...
def lambda_handler(event, context):
    ...
    __TableName__ = 'DEKAYBAL-streaming-dynamodb' # <-- Insert your table name
    # Configure Firehose service as part of Step 6
    firehose_name = 'dekaybal-deliverystream' # <-- Insert your Firehose name
    # ===================================================================================
    ...
    table = dynamodb.Table('DEKAYBAL-streaming-dynamodb') # <-- Write code to update the value of this variable.
    # ===================================================================================
